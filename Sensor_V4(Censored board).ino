...
void loop() {
  // put your main code here, to run repeatedly:
   ...
   float MQ5val= analogRead(MQ5);
   float MQ3val= analogRead(MQ3);
   float MQ6val= analogRead(MQ6);
...
float h1=dht22.readHumidity();
 ...
 float ph_act = -5.70 * volt + calibration_value+3.1;
  ...
  Serial.println(MQ3val*100/4095);//reading gas sensor MQ3 value
  Serial.print("MQ5 Reading: ");
  Serial.println(MQ5val*100/4095);//reading gas sensor MQ5 value
  Serial.print("MQ6 Reading: ");
  Serial.println(MQ6val*100/4095);//reading gas sensor MQ6 value
